...
| Table 1 (Measles vs Chickenpox CCF diffs) | `analysis/cross_correlation.R` | `data/analysis_intermediates/table1_measles_chickenpox_ccf_diff.csv` |
| Table 2 (Measles vs Meningitis CCF diffs) | `analysis/cross_correlation.R` | `data/analysis_intermediates/table2_measles_meningitis_ccf_diff.csv` |
| Table 3 (Chickenpox vs Mumps CCF diffs) | `analysis/cross_correlation.R` | `data/analysis_intermediates/table3_chickenpox_mumps_ccf_diff.csv` |
