...
\toprule
Stage & Operation & All cells (n=53{,}872) & Numeric, manual reference (n=28{,}255) & Numeric, both sources (n=26{,}069) & Rule provenance \\
\midrule
...
3 & Manual adjudication (Meningitis, Mumps) & not quantified & not quantified & not quantified & manual, post-hoc \\
\bottomrule
\end{tabular}
